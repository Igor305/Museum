...
namespace DataAccessLayer.AppContext
{
    public partial class ShopsContext : DbContext
    {
        ...
        public virtual DbSet<UserShopGridFilterSetting> UserShopGridFilterSettings { get; set; }
        public virtual DbSet<UserShopGridSetting> UserShopGridSettings { get; set; }
        public virtual DbSet<UserShopGridSortSetting> UserShopGridSortSettings { get; set; }
...
//#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<UserShopGridFilterSetting>(entity =>
            {
                entity.HasIndex(e => e.UserId, "IX_UserShopGridFilterSettings_UserId");
                ...
                entity.HasOne(d => d.User)
                    .WithMany(p => p.UserShopGridFilterSettings)
                    .HasForeignKey(d => d.UserId);
            });
            ...
            modelBuilder.Entity<UserShopGridSortSetting>(entity =>
            {
                entity.HasIndex(e => e.UserId, "IX_UserShopGridSortSettings_UserId");
                ...
                entity.HasOne(d => d.User)
                    .WithMany(p => p.UserShopGridSortSettings)
                    .HasForeignKey(d => d.UserId);
            });
